...
var o19334 = temp__5733__auto__;
var temp__5733__auto____$1 = (o19334["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o19335 = temp__5733__auto____$1;
return (o19335["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__19151__auto__ = f;
return (o__19151__auto__["toString"]).call(o__19151__auto__);
} else {
return "";
}
}catch (e19336){var _ = e19336;
return "";
}});
...
try{var o__19151__auto___19338 = t;
(o__19151__auto___19338["cljs$lang$ctorPrWriter"]).call(o__19151__auto___19338,t,writer);
}catch (e19337){var __19339 = e19337;
}
...
var char_code = (function (){var o__19151__auto__ = (new String(char$));
return (o__19151__auto__["charCodeAt"]).call(o__19151__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__19151__auto__ = String;
return (o__19151__auto__["fromCharCode"]).call(o__19151__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__19340 = num_code;
switch (G__19340) {
case (1):
return (185);
...
var o__19151__auto__ = String;
return (o__19151__auto__["fromCharCode"]).call(o__19151__auto__,superscript_code);
});
/**
...
}catch (e19342){var _e__19158__auto__ = e19342;
return false;
}})())){
...
var vec__19343 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__19343,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o19346 = temp__5733__auto__;
var temp__5733__auto____$1 = (o19346["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o19347 = temp__5733__auto____$1;
return (o19347["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4736__auto___19354 = arguments.length;
var i__4737__auto___19355 = (0);
while(true){
if((i__4737__auto___19355 < len__4736__auto___19354)){
args__4742__auto__.push((arguments[i__4737__auto___19355]));

var G__19356 = (i__4737__auto___19355 + (1));
i__4737__auto___19355 = G__19356;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__19350){
var vec__19351 = p__19350;
var ns_detector = cljs.core.nth.call(null,vec__19351,(0),null);
...
var G__19357 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__19358 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__19357;
remaining_tokens = G__19358;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq19348){
var G__19349 = cljs.core.first.call(null,seq19348);
var seq19348__$1 = cljs.core.next.call(null,seq19348);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19349,seq19348__$1);
}));
...
var vec__19362 = cljs.core.split_with.call(null,(function (p1__19361_SHARP_){
return cljs.core.not_EQ_.call(null,p1__19361_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__19362,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__19362,(1),null);
...
var vec__19368 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__19368,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__19368,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__19371 = cljs.core.rest.call(null,remaining_tokens);
var G__19372 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__19371;
name_tokens = G__19372;
continue;
} else {
...
var vec__19375 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__19375,(0),null);
var arity = cljs.core.nth.call(null,vec__19375,(1),null);
var vec__19378 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__19378,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__19378,(1),null);
var vec__19381 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__19381,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__19381,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__19381,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__19381,(3),null);
...
var vec__19387 = result;
var munged_ns = cljs.core.nth.call(null,vec__19387,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__19387,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__19387,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__19387,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__19387,(4),null);
var arity = cljs.core.nth.call(null,vec__19387,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__19391 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__19391,(0),null);
var args = cljs.core.nth.call(null,vec__19391,(1),null);
var vec__19394 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__19394,(0),null);
var name = cljs.core.nth.call(null,vec__19394,(1),null);
...
var G__19397 = (arity + (1));
var G__19398 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__19399){
var vec__19400 = p__19399;
var arity = cljs.core.nth.call(null,vec__19400,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__19400,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__19403_SHARP_){
return cljs.core.get.call(null,arities,p1__19403_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__19404_SHARP_){
return cljs.core.drop.call(null,(2),p1__19404_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___19411 = arguments.length;
var i__4737__auto___19412 = (0);
while(true){
if((i__4737__auto___19412 < len__4736__auto___19411)){
args__4742__auto__.push((arguments[i__4737__auto___19412]));

var G__19413 = (i__4737__auto___19412 + (1));
i__4737__auto___19412 = G__19413;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__19407){
var vec__19408 = p__19407;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__19408,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq19405){
var G__19406 = cljs.core.first.call(null,seq19405);
var seq19405__$1 = cljs.core.next.call(null,seq19405);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19406,seq19405__$1);
}));
...
var map__19416 = options;
var map__19416__$1 = (((((!((map__19416 == null))))?(((((map__19416.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__19416.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__19416):map__19416);
var include_ns_QMARK_ = cljs.core.get.call(null,map__19416__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__19416__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__19416__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__19416__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__19417 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__19417,(0),null);
var fn_name = cljs.core.nth.call(null,vec__19417,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__19417,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__19417,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__19417,(4),null);
var arity = cljs.core.nth.call(null,vec__19417,(5),null);
...
var o__19151__auto__ = f;
return (o__19151__auto__["getBasis"]).call(o__19151__auto__);
});
/**
...
}catch (e19421){var _e__19158__auto__ = e19421;
...
var G__19422 = (obj[cljs.core.first.call(null,path)]);
var G__19423 = cljs.core.rest.call(null,path);
obj = G__19422;
path = G__19423;
continue;
} else {
...
var _STAR_ = (function (accum,p__19424){
var vec__19425 = p__19424;
var bit = cljs.core.nth.call(null,vec__19425,(0),null);
var protocol = cljs.core.nth.call(null,vec__19425,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__19428){
var vec__19429 = p__19428;
var ns = cljs.core.nth.call(null,vec__19429,(0),null);
var name = cljs.core.nth.call(null,vec__19429,(1),null);
var selector = cljs.core.nth.call(null,vec__19429,(2),null);
...
var post_process = (function (p__19433){
var vec__19434 = p__19433;
var munged_name = cljs.core.nth.call(null,vec__19434,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__19434,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__19432_SHARP_){
return (obj[cljs.core.first.call(null,p1__19432_SHARP_)]);
}),sorted_matches);
