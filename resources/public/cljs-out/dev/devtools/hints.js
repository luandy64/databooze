...
}catch (e24581){var _e = e24581;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___24584 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5733__auto___24584)){
var seen_errors_24585 = temp__5733__auto___24584;
if(cljs.core.truth_(seen_errors_24585.has(self))){
} else {
seen_errors_24585.add(self);

var temp__5735__auto___24586 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5735__auto___24586)){
var sense_24587 = temp__5735__auto___24586;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_24587)].join(''));
} else {
}
}
} else {
