...
var len__4736__auto___19957 = arguments.length;
var i__4737__auto___19958 = (0);
while(true){
if((i__4737__auto___19958 < len__4736__auto___19957)){
args__4742__auto__.push((arguments[i__4737__auto___19958]));

var G__19959 = (i__4737__auto___19958 + (1));
i__4737__auto___19958 = G__19959;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq19954){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19955,G__19956,seq19954__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__19960_SHARP_){
return (!((cljs.core.meta.call(null,p1__19960_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__19961__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e19965){var _e__19158__auto__ = e19965;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e19967){var _e__19158__auto__ = e19967;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__19969 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__19970 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__19970);

try{var map__19971 = opts;
var map__19971__$1 = (((((!((map__19971 == null))))?(((((map__19971.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__19971.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__19971):map__19971);
var markup_db = cljs.core.get.call(null,map__19971__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__19969);
}});
...
var temp__5733__auto___19976 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5733__auto___19976)){
var managed_print_level_19977 = temp__5733__auto___19976;
var _STAR_print_level_STAR__orig_val__19974_19978 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__19975_19979 = managed_print_level_19977;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__19975_19979);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__19973_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__19973_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__19974_19978);
}} else {
job_fn.call(null);
}
