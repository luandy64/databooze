...
var G__19908 = devtools.prefs.pref.call(null,v);
v = G__19908;
continue;
} else {
return v;
...
}catch (e19911){var _e__19158__auto__ = e19911;
return false;
}})();
...
}catch (e19915){var _e__19158__auto__ = e19915;
return false;
}})();
...
}catch (e19917){var _e__19158__auto__ = e19917;
return false;
}}
}
});
...
var vec__19919 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__19919,(0),null);
var name = cljs.core.nth.call(null,vec__19919,(1),null);
...
return cljs.core.some.call(null,(function (p1__19922_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__19922_SHARP_);
}),template);
});
