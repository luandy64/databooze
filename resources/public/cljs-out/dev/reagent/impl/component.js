...
if((i < len)){
var k = (ks[i]);
var G__13238 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__13239 = (i + (1));
m = G__13238;
i = G__13239;
continue;
...
var temp__5737__auto__ = p.argv;
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__13240 = p.children;
return reagent.impl.component.global$module$react.Children.toArray(G__13240);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__13242 = c;
var G__13242__$1 = (((G__13242 == null))?null:G__13242.prototype);
if((G__13242__$1 == null)){
return null;
} else {
return G__13242__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__13244 = c;
var G__13244__$1 = (((G__13244 == null))?null:G__13244.prototype);
if((G__13244__$1 == null)){
return null;
} else {
return G__13244__$1.render;
}
})() == null)))));
});
...
var G__13246 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__13246) : reagent.impl.component.as_element.call(null,G__13246));
};
...
var G__13252 = c;
var G__13252__$1 = (((G__13252 == null))?null:G__13252.constructor);
if((G__13252__$1 == null)){
return null;
} else {
return G__13252__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__13253 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__13254 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__13254);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__13253);
}});
...
var c = this;
var G__13258_13260 = goog.object.get(c,"cljsRatom");
if((G__13258_13260 == null)){
} else {
reagent.ratom.dispose_BANG_(G__13258_13260);
}
...
var renders_13261 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender], null));
var render_fun_13262 = cljs.core.first(cljs.core.vals(renders_13261));
...
if((cljs.core.count(renders_13261) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_13261))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_13262)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_13262], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__13263 = o;
goog.object.set(G__13263,cljs.core.name(k),v);
