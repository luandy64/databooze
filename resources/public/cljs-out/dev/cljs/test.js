...
var G__17689 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__17689,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__17689;
}
}));
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq17691){
var G__17692 = cljs.core.first.call(null,seq17691);
var seq17691__$1 = cljs.core.next.call(null,seq17691);
var G__17693 = cljs.core.first.call(null,seq17691__$1);
var seq17691__$2 = cljs.core.next.call(null,seq17691__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__17692,G__17693,seq17691__$2);
}));
...
var file = cljs.core.get.call(null,map__17698__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__17698__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__17698__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__17697_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__17697_SHARP_));
...
var temp__5735__auto___17700 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___17700)){
var message_17701 = temp__5735__auto___17700;
cljs.core.println.call(null,message_17701);
} else {
}
...
var temp__5735__auto___17702 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___17702)){
var message_17703 = temp__5735__auto___17702;
cljs.core.println.call(null,message_17703);
} else {
}
...
var output_dir__$1 = (function (){var G__17704 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__17704,"/"].join('');
} else {
return G__17704;
}
})();
...
var temp__5733__auto__ = ((typeof exception.stack === 'string')?(function (){var G__17706 = exception.stack;
var G__17706__$1 = (((G__17706 == null))?null:clojure.string.split_lines.call(null,G__17706));
var G__17706__$2 = (((G__17706__$1 == null))?null:cljs.core.get.call(null,G__17706__$1,depth));
if((G__17706__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__17706__$2);
}
})():false);
if(cljs.core.truth_(temp__5733__auto__)){
var stack_element = temp__5733__auto__;
var fname = cljs.test.js_filename.call(null,stack_element);
var vec__17707 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__17707,(0),null);
var column = cljs.core.nth.call(null,vec__17707,(1),null);
var vec__17710 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__17710,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__17710,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__17710,(2),null);
...
var m__$1 = (function (){var G__17713 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__17717 = (function (){var G__17716 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__17716);
} else {
return G__17716;
}
})();
...
return cljs.core.vary_meta.call(null,G__17718,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__17722 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__17722,(0),null);
...
return cljs.core.map.call(null,(function (p__17725){
var vec__17726 = p__17725;
var ns = cljs.core.nth.call(null,vec__17726,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__17726,(1),null);
return (function (){
...
var G__17729 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
var seq__17730 = cljs.core.seq.call(null,vars__$1);
var chunk__17731 = null;
var count__17732 = (0);
var i__17733 = (0);
while(true){
if((i__17733 < count__17732)){
var v = cljs.core._nth.call(null,chunk__17731,i__17733);
var temp__5735__auto___17735 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___17735)){
var t_17736 = temp__5735__auto___17735;
each_fixture_fn.call(null,((function (seq__17730,chunk__17731,count__17732,i__17733,t_17736,temp__5735__auto___17735,v,each_fixture_fn,G__17729,G__17729__$1,env,once_fixtures,each_fixtures,vec__17726,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_17736)));
});})(seq__17730,chunk__17731,count__17732,i__17733,t_17736,temp__5735__auto___17735,v,each_fixture_fn,G__17729,G__17729__$1,env,once_fixtures,each_fixtures,vec__17726,ns,vars__$1))
);
} else {
}


var G__17737 = seq__17730;
var G__17738 = chunk__17731;
var G__17739 = count__17732;
var G__17740 = (i__17733 + (1));
seq__17730 = G__17737;
chunk__17731 = G__17738;
count__17732 = G__17739;
i__17733 = G__17740;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq.call(null,seq__17730);
if(temp__5735__auto__){
var seq__17730__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__17730__$1)){
var c__4556__auto__ = cljs.core.chunk_first.call(null,seq__17730__$1);
var G__17741 = cljs.core.chunk_rest.call(null,seq__17730__$1);
var G__17742 = c__4556__auto__;
var G__17743 = cljs.core.count.call(null,c__4556__auto__);
var G__17744 = (0);
seq__17730 = G__17741;
chunk__17731 = G__17742;
count__17732 = G__17743;
i__17733 = G__17744;
continue;
} else {
var v = cljs.core.first.call(null,seq__17730__$1);
var temp__5735__auto___17745__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___17745__$1)){
var t_17746 = temp__5735__auto___17745__$1;
each_fixture_fn.call(null,((function (seq__17730,chunk__17731,count__17732,i__17733,t_17746,temp__5735__auto___17745__$1,v,seq__17730__$1,temp__5735__auto__,each_fixture_fn,G__17729,G__17729__$1,env,once_fixtures,each_fixtures,vec__17726,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_17746)));
});})(seq__17730,chunk__17731,count__17732,i__17733,t_17746,temp__5735__auto___17745__$1,v,seq__17730__$1,temp__5735__auto__,each_fixture_fn,G__17729,G__17729__$1,env,once_fixtures,each_fixtures,vec__17726,ns,vars__$1))
);
} else {
}


var G__17747 = cljs.core.next.call(null,seq__17730__$1);
var G__17748 = null;
var G__17749 = (0);
var G__17750 = (0);
seq__17730 = G__17747;
chunk__17731 = G__17748;
count__17732 = G__17749;
i__17733 = G__17750;
continue;
}
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__17729__$1)].join('')));
